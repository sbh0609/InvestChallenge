...
public class ConnectDB {
	...
	String jdbc_url = "jdbc:mysql://127.0.0.1/investchallenge?allowPublicKeyRetrieval=true&useUnicode=true&characterEncoding=utf8&useSSL=false&serverTimezone=UTC";
	...
	public static void main(String[] args) {
        ...
        if (db.getConn() != null) {
            System.out.println("데이터베이스 연결 성공!");
            try {
                String sql = "SELECT id FROM user_stocks";
